...
import { keyframes, easing, timing } from "../../styles/animations";
...
// Styled Container
const EmptyStateContainer = styled(Box)(({ animation }) => ({
  display: "flex",
...
const IconContainer = styled(Box)(({ iconAnimation }) => ({
  marginBottom: "32px",
 ...
 */
export const NoDataEmptyState = ({ onUploadClick }) => {
  return (
 ...
 */
export const NoResultsEmptyState = ({ onClearFilters, message = "No results found" }) => {
  return (
 ...
 */
export const ErrorEmptyState = ({ errorMessage = "Something went wrong", onRetry, retryLabel = "Try Again" }) => {
  return (
 ...
 */
export const LoadingEmptyState = ({ message = "Loading your data..." }) => {
