...
import { Card, Typography, Box, Divider, alpha, useTheme } from "@mui/material";
 ...
 */
export const StatusChartTooltip = ({ active, payload, showIO = true }) => {
 ...
 */
export const RevenueChartTooltip = ({ active, payload, label, showIO = true }) => {
  const theme = useTheme();
 ...
 */
export const SimpleChartTooltip = ({ active, payload, label, valueLabel = "Value" }) => {
  const theme = useTheme();
