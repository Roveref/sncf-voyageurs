 ...
 */
const createStackedGroup = (name, extra = {}) => ({
  name,
  early: 0,
  earlyAllocated: 0,
  earlyNonAllocated: 0,
 ...
 */
const addToStatusBucket = (group, status, { base, allocated, nonAllocated, calculated, countIncrement }) => {
 ...
 */
export const usePipelineByServiceLine = (filteredOpportunities, showNetRevenue) => {
  /**
